...
hpref <- hps[[1]]
proflegs <- paste(hpref$collection, " URI-R: ", format(hpref$urir_count, big.mark=","), " URI-M/R: ", round(hpref$urim_urir_ratio, 3), " CDX: ", f2si2(hpref$cdx_size, rounding=T, sep=""), sep="")
